...
HEQ_CHOICES = [(key, value) for key, value in HEQ.items()]
class Employee(models.Model):
    staffno = models.CharField('Staff Number',max_length=12,blank=False,null=False,primary_key=True,unique=True)
    title = models.CharField('Title of Courtesy',max_length=20,blank=False,null=False,choices=TITLE)
    ...
    suffix = models.CharField('Name Suffixe',max_length=20,blank=True,null=True,choices=SUFFIX)
    ...
    heq = models.CharField('Highest Academic Qualification',max_length=100,blank=True,null=True,choices=HEQ)
    ...
    active_status = models.CharField('Staff Status',max_length=25,blank=False,default='Active',null=False,choices=STAFFSTATUS)
    home_town = models.CharField('Home Town',max_length=100,blank=True,null=True)
    region  = models.CharField('Region',max_length=50,blank=True,null=True,choices=REGION)
    rba = models.CharField('Role-Based Access',max_length=10,blank=False,default='REG',null=False,choices=RBA)
    doe = models.DateField('Date Employed')
    staff_rank = models.CharField('Staff Rank',max_length=50,blank=True,null=True,choices=STAFFRANK)
...
class Staff_School(models.Model):
    ...
    certification = models.CharField('Certification',max_length=250,blank=True,null=True,choices=HEQ)
    notes = models.TextField('Notes',blank=True,null=True)
    updated = models.DateTimeField(auto_now=True)
    created = models.DateTimeField(auto_now_add=True)
...
class Medical(models.Model):
    ...
    relationship = models.CharField(choices=DEPENDANTS) # Select from Self, Spouse, Child
...
class Kith(models.Model):
     ...
     kith_relationship = models.CharField(choices=DEPENDANTS)
     kith_gender = models.CharField(choices=GENDER)
